...
"""To Do:
- Check the outcome depending on the contact
- Find what is the avverage number of contacts before success (1, 2, 3...) in percentage
- View All of this by month, day...
- Test Call Centre Volume
- The two junk values - check the success...
"""
